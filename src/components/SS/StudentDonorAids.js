...
import SSHeaderStats from "./SSHeaderStats.js"
// views
...
export default function StudentDonorAids() {
  const cardItemStyle = {
  ...
  return (
    ...
    <div>
      ...
      <div className="md:ml-64 bg-blueGray-100 flex flex-col items-center">
        <div className="py-5 text-xl font-semibold mx-auto">Get Aid</div>
  ...
  <div className="text-center mt-5">
    ...
    <p className="text-lg font-semibold text-blue-500 mt-2">donor name</p>
    <p className="text-lg font-semibold text-blue-500 mt-2">120000</p>
    <p className="text-lg font-semibold text-blue-500 mt-2">description</p>
    
    <form className="flex flex-col align-center items-center justify-center">
        <label for="supportingDocument" className="text-lg font-semibold text-blue-500 mt-2">Supporting Document</label>
        <input type="file" id="supportingDocument" name="supportingDocument" accept=".pdf, .doc, .docx" className="mt-2" />
    </form>
    <div className="mx-auto mt-2 text-center" style={buttonItemStyle}>Apply</div>
